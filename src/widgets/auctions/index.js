...
import doubleArrow from '../../shared/assets/test-content/doubleArrow.svg';
...
export const PlotAuction = () => {
  ...
  const tempData = [{
    title: "Заголовок как этапа",
    description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquet."
  },
  {
    title: "Заголовок как этапа",
    description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquet."
  ...
  return (
    <>
      <div className={cls.plotListWrapper}>
        ...
        <div className={cls.auctionBlock}>
          {tempData.map((temp, i) => {
            return (
              <div className={cls.auctionBlock}>
                <img src={doubleArrow} alt="doubleArrow" />
                <div className={cls.auctionContent}>
                  <span className={cls.title}>{temp.title}</span>
                  <span className={cls.description}>{temp.description}</span>
                </div>
              </div>
            )
          })}
