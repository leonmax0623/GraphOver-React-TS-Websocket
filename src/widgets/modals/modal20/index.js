...
export const Modal20 = ({ isOpen, setIsOpen }) => {
    return (
        <Modal className={cls.modal} isOpen={isOpen} setIsOpen={setIsOpen}>
            <Title3 className={cls.title}>Выбрать данного исполнителя?</Title3>
            <p className={cls.text}>С вашего счета будет списано <strong>2324</strong> БиТ и сохранены в сейфе сделки до принятия работы Исполнителя</p>
